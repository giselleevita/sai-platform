...
export default function RisksPage() {
  ...
  // Risks are already sorted by the API
    ...
    <AppLayout>
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        {error && (
          <div className="mb-6 rounded-md bg-red-50 p-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <button
                onClick={() => loadRisks(pagination.page)}
        ...
        <div className="mb-6 bg-white rounded-lg shadow p-4 space-y-4">
          <form onSubmit={(e) => { e.preventDefault(); loadRisks(1); }} className="flex gap-4">
        ...
        {pagination.totalPages > 1 && (
          <div className="mb-6 flex items-center justify-between bg-white rounded-lg shadow p-4">
            <button
              onClick={() => loadRisks(pagination.page - 1)}
